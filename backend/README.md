...
## Project Structure
    ...
    ├── testapiautocatalog_122053  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_122053`
...
2. Clone this repo and `cd testapiautocatalog_122053`
